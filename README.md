...
- :bug: há um bug na invocação assíncrona da lambda `products-admin` e `products-event`. Sempre no coldstart da `products-event`, ela acaba sendo invocada 3 vezes, inserindo 3 registros de eventos repetidos na tabela `events` do dynamodb.
